...
public final class BoxButton extends JButton implements ActionListener {
	...
	public void notifyForUpdate() {
		...
		if(dijkstraApp.getDijkstraAppModel().getCurrentBox() == mBox && !dijkstraApp.getDijkstraAppModel().isBeingEdited())
			setSelected(true);
		else if(dijkstraApp.getDijkstraAppModel().getCurrentBox() == dijkstraApp.getDijkstraAppModel().getDepartureBox() && mBox != dijkstraApp.getDijkstraAppModel().getDepartureBox())
			setSelected(false);
		else if(dijkstraApp.getDijkstraAppModel().isShowTheWholePath() && dijkstraApp.getDijkstraAppModel().getShortestPathIDs().contains(mBox.getId()))
			setSelected(true);
